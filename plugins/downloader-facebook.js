...
if (!args[0].match(/www.facebook.com|fb.watch/g)) throw `*[❗𝐈𝐍𝐅𝐎❗] ENTER A FACEBOOK LINK , EXAMPLE: ${usedPrefix + command}* https://fb.watch/fOTpgn6UFQ/`
try {
await m.reply(`*[❗]Please wait as i download your video, it will take a while depending on the size of the video...*`)      
